...
const LogoForm = FormHoc(class extends React.Component {
    ...
    render() {
        ...
        return React.createElement(
            ...
            initial === null && React.createElement(
                'div',
                { className: 'alert alert-warning' },
                '\xDChtegi faili pole seni \xFCles laetud.'
            ),
            initial !== null && React.createElement(
                'div',
                { className: 'vt-settings-image' },
                React.createElement('img', { src: '/settings/file/logo', alt: 'Logo fail' })
            ),
...
ReactDOM.render(React.createElement(LogoForm, {
    meta: meta,
    submit: submit,
    success: success,
    validate: validate }), document.getElementById('logo-form-root'));
