...
const Textarea = __webpack_require__(6);
const FormHoc = __webpack_require__(7);
const validate = __webpack_require__(8);
const jsonScript = __webpack_require__(10);
...
const MainSettingsForm = FormHoc(props => {
    ...
    return React.createElement(
        ...
        React.createElement(TextInput, {
            ...
            label: '\xDClemine versiooninumber',
            placeholder: '\xDClemine versiooninumber',
...
ReactDOM.render(React.createElement(MainSettingsForm, {
    submit: submit,
    success: success,
    validate: validate,
    initial: initial }), document.getElementById('main-form-root'));
