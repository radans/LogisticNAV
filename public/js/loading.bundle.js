...
const LoadingForm = FormHoc(class extends React.Component {
    ...
    render() {
        ...
        return React.createElement(
            'form',
            { className: 'vt-form', onSubmit: this.submit },
            ...
            initial.et === null && React.createElement(
                'div',
                { className: 'alert alert-warning' },
                'Eestikeelset juhendit pole veel \xFCles laetud.'
            ),
            initial.en === null && React.createElement(
                'div',
                { className: 'alert alert-warning' },
                'Inglisekeelset juhendit pole veel \xFCles laetud.'
            ),
            initial.ru === null && React.createElement(
                'div',
                { className: 'alert alert-warning' },
                'Venekeelset juhendit pole veel \xFCles laetud.'
            ),
            React.createElement(
                FormGroup,
                null,
                React.createElement(
                    ...
                    initial.et !== null && React.createElement(
                        ...
                        React.createElement(
                            'a',
                            { href: '/settings/file/loading_et',
                                target: '_blank' },
                            'Praegune eestikeelne juhend'
                        )
                    ),
                    initial.en !== null && React.createElement(
                        'li',
                        ...
                        React.createElement(
                            'a',
                            { href: '/settings/file/loading_en',
                                target: '_blank' },
                            'Praegune inglisekeelne juhend'
                        )
                    ),
                    initial.ru !== null && React.createElement(
                        'li',
                        ...
                        React.createElement(
                            'a',
                            { href: '/settings/file/loading_ru',
                                target: '_blank' },
                            'Praegune venekeelne juhend'
                        )
                    )
                )
            ),
...
ReactDOM.render(React.createElement(LoadingForm, {
    meta: meta,
    submit: submit,
    success: success,
    validate: validate }), document.getElementById('loading-form-root'));
